...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.show_invisible'
        db.add_column(u'ed_news_userprofile', 'show_invisible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.show_invisible'
        db.delete_column(u'ed_news_userprofile', 'show_invisible')
