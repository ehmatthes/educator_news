...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field flags on 'Article'
        m2m_table_name = db.shorten_name(u'ed_news_article_flags')
    ...
    def backwards(self, orm):
        # Removing M2M table for field flags on 'Article'
        db.delete_table(db.shorten_name(u'ed_news_article_flags'))
