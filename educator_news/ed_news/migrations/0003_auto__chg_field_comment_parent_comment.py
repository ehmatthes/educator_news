...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'ed_news_comment', 'parent_comment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ed_news.Comment'], null=True))

    def backwards(self, orm):

        # Changing field 'Comment.parent_comment'
        db.alter_column(u'ed_news_comment', 'parent_comment_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ed_news.Comment']))
