...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.show_all'
        db.delete_column(u'ed_news_userprofile', 'show_all')


    def backwards(self, orm):
        # Adding field 'UserProfile.show_all'
        db.add_column(u'ed_news_userprofile', 'show_all',
