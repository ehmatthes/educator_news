...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'ed_news_comment', 'comment_text', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Comment.comment_text'
        db.alter_column(u'ed_news_comment', 'comment_text', self.gf('django.db.models.fields.CharField')(max_length=10000))
