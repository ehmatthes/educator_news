...
class Migration(SchemaMigration):
	...
	# Renaming field 'Article.author' to 'Article.submitter'
	db.rename_column(u'ed_news_article', 'author_id', 'submitter_id')

    def backwards(self, orm):
	# Renaming field 'Article.submitter' to 'Article.author'
	db.rename_column(u'ed_news_article', 'submitter_id', 'author_id')
