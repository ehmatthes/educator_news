...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Comment.alive'
        db.delete_column(u'ed_news_comment', 'alive')

        # Adding field 'Comment.visible'
        db.add_column(u'ed_news_comment', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Comment.alive'
        db.add_column(u'ed_news_comment', 'alive',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Comment.visible'
        db.delete_column(u'ed_news_comment', 'visible')
